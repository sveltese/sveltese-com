...
const Schema: z.ZodType<Prisma.team_invitationsUpdateManyWithoutTeamsNestedInput> = z
	.object({
		create: z
			.union([
...
export const team_invitationsUpdateManyWithoutTeamsNestedInputObjectSchema = Schema;
